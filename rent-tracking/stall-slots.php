                          ...
                          <tr data-id="2">
                              ...
                              <td data-label="File">
                                ...
                                <div text-wrap class="mb-2 d-flex align-items-start column-gap-2">
                                  <a class="text-wrap"  target="_blank" href="upload/<?= $row2['stall_file']; ?>"><?= $row2['stall_file']; ?></a>
                                  <small class="delete_data"
                                                  role="button"
                                                  data-id="<?= $row2['stall_slots_file_id']; ?>"
                                                  data-table="stall_slots_file"
                                                  data-type="stall_slots_file_id"
                                              >
                              ...
                              <td data-label="Action" width="160">
                                    <div class="d-flex flex-column flex-lg-row align-items-lg-center gap-2">
                                        ...
                                        <small data-id="<?= $stall_slots_id; ?>" role="button" class="upload_file py-1 px-2 rounded-1 text-bg-secondary text-decoration-none d-flex align-items-center">
                                          <i class="fa-solid fa-upload me-2"></i><span>Upload</span>
                                        </small>
                                      <small>
                                        <a href="transaction?stall_slots_id=<?= $stall_slots_id; ?>" target="_blank" class="edit_category py-1 px-2 rounded-1 text-bg-warning text-decoration-none d-flex align-items-center">
                                          <i class="fa-solid fa-wallet me-2"></i><span>Transactions</span>
                                        </a>
                                      </small>
                                      <small>
                                        <a type="button" class="edit_tenant py-1 px-2 rounded-1 text-bg-primary text-decoration-none d-flex align-items-center"
                                        data-data1="<?= $stall_slots_id; ?>"
                                        data-data2="<?= $tenantname; ?>"
                                        data-data3="<?= $monthly; ?>"
                                        data-data4="<?= $email; ?>"
                                        data-data5="<?= $phonenumber; ?>"
                                        data-data6="<?= $location; ?>"
                                        data-data7="<?= $manager_name; ?>"
                                        >
