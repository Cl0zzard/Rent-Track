	    ...
	    <div class="content-div">
	        ...
	        <div class="row row-gap-2 mx-0 mt-2 p-3">
		           ...
		           <?php
		              ...
		              foreach ($queries as $query) {
		                  ...
		                  <div class="col-12 col-xl-4">
		                      <div class="border border-top-0 border-bottom-0 border-end-0 p-4 rounded-2 shadow-sm" style="border-left: 4px solid var(--primary) !important; background-color: <?= $query['background'] ?>;">
		                          <div>
		        ...
		        <div class="col-12 row mx-0 gap-5">
		            <!-- Bar Chart Container -->
		            <div class="col-11 col-md-10 col-lg-8 shadow d-flex flex-column align-items-center justify-content-between border border-1 p-0 rounded-2">
		            ...
		            <!-- Pie Chart Container -->
		            <div class="col-11 col-md-5 col-lg-3 shadow d-flex flex-column align-items-center justify-content-center border border-1 p-0 rounded-2">
		            ...
		            <div class="col-11 shadow d-flex flex-column align-items-center justify-content-between border border-1 p-0 rounded-2">
		                <div class="text-center px-3 py-4 bg-secondary-subtle w-100 fw-bold">
		                    Monthly Rate
		                </div>
		                <div class="w-100 p-3">
