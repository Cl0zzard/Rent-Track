      		...
      		<div class="modal-body position-relative">
                ...
                <form method="POST" action="controller/add-tenant.php" enctype="multipart/form-data" class="d-flex flex-column row-gap-4 p-5">
    			    ...
    			    <div class="d-flex flex-column flex-lg-row gap-2 ">
	    			    ...
	    			    <div class="form-floating w-100">
	    			        <input required type="text" name="monthly" id="monthly" class="form-control rounded-1" placeholder="input here">
    			    ...
    			    <div class="d-flex flex-column flex-lg-row gap-2 ">
	    			    ...
	    			    <div class="form-floating w-100">
	    			        <input required type="text" name="phonenumber" id="phonenumber" class="form-control rounded-1" placeholder="input here">
