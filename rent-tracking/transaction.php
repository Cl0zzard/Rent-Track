              ...
              <div class="d-flex flex-column row-gap-2 p-3">
                    <div class="d-flex align-items-center justify-content-between">
                      ...
                      <div class="d-none d-lg-flex align-items-center gap-2">
                        <a  target ="_blank" href="transaction-print.php?stall_slots_id=<?= $get_stall_slots_id?>" class=" btn btn-sm btn-secondary rounded-1 py-2">
                      ...
                      <div class="d-flex d-lg-none align-items-center gap-2">
                        <a type="button" data-bs-toggle="modal" href="#transaction-modal" class="btn btn-sm btn-primary rounded-1 py-2">
                            ...
                            <tr data-id="2">
                              ...
                              <td data-label="Action" width="160">
                                    <div class="d-flex align-items-center column-gap-3">
                                      ...
                                      <small>
                                        <a type="button" target="_blank" class="edit_transaction py-1 px-2 rounded-1 text-bg-primary text-decoration-none d-flex align-items-center"

                                          data-data1="<?= $transaction_history_id ? $transaction_history_id : null; ?>"
                                          data-data2="<?= $balance != null ? $balance :  '0'; ?>"
                                          data-data3="<?= $penalty != null ? $penalty : '0'; ?>"
                                          data-data4="<?= $status; ?>"
                                          data-data5="<?= $duedate; ?>" 
                                            >
                                      ...
                                      <small class="delete_data py-1 px-2 rounded-1 text-bg-danger d-flex align-items-center"
                                                role="button"
                                                data-id="<?= $transaction_history_id; ?>" 
                                                data-table="transaction_history" 
