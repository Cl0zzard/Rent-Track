...
<div id="loader-div" class="d-none position-fixed h-100 w-100 top-0 end-0 start-0 bottom-0"
    style="background: rgba(0, 0, 0, 0.6); z-index: 3000;">
...
<div class="sidebar shadow-sm" style="background-color: var(--dark-red) !important;">
    ...
    <ul class="navbar-nav mt-3 px-3 gap-1 position-relative h-100">
        ...
        if ($_SESSION['admin']['role'] === 1) {
            ...
            <li class="nav-item">
                <a href="#accountList" data-bs-toggle="collapse" aria-expanded="false" aria-controls="accountList"
                    class="py-2 px-3 nav-link d-flex align-items-center justify-content-start column-gap-3 position-relative">
                    <i class="fa-solid fa-user-gear text-dark"></i>
                    <small class="fw-bold text-nowrap">
                        <span>Management</span>
                        <i class="fa-solid fa-angle-down position-absolute end-0 pe-3"
                ...
                <div class="collapse" id="accountList">
                    <a href="management?account_status=1" class="py-2 nav-link">
                        <div class="ms-5 sub text-nowrap">
                            ...
                            <small class="fw-bold ">Registered Accounts</small>
                        </div>
                    </a>
                    <a href="management?account_status=2" class="py-2 nav-link">
                        <div class="ms-5 sub text-nowrap">
                            <small><i class="fa-solid fa-chevron-right me-1 text-dark"></i></small>
                            <small class="fw-bold ">Archived Accounts</small>
                        </div>
                    </a>
                </div>
            </li>
        ...
        <?php if (in_array($_SESSION['admin']['role'], [1, 2])): ?>
            <li class="nav-item">
                <a href="stall-slots"
                    class="py-2 px-3 nav-link d-flex align-items-center justify-content-start column-gap-3">
                    <div class="icon-size text-dark">
